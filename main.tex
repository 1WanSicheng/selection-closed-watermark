...
\begin{table}[h]
\caption{Guarantee levels by construction.}
\label{tab:tiers}
\begin{center}
\small
\begin{tabular}{lccc}
...
PRF-derived subkeys ($\mathrm{JC}_N$) & exact & computationally product & computational closure \\
...
(Proposition~\ref{prop:hierarchy}). Union detection scales linearly in the
...
\subsection{Proofs of Theorems~\ref{thm:exactlift} and~\ref{thm:lifting}}
