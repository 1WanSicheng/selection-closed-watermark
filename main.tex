...
reward $0.0698\approx0.0703$ (candidate marginal unchanged), hard-BoN $0.0861$
vs.\ reference $0.0848$ --- numerically slightly above the unwatermarked
reference and within the uncertainty of the current evaluation. In
gain-retained terms
($(R_N{-}R_1)_{\mathrm{method}}/(R_N{-}R_1)_{\mathrm{unwm}}$): shared key
$0\%$, softened $107\%$, candidate-separated $112\%$ --- the latter two
consistent with full recovery.
