...
aggregate decays exactly along Eq.~\eqref{eq:aggsignal} in the high-entropy
regime (machine-precision agreement) and collapses in the low-entropy regime,
where Eq.~\eqref{eq:aggsignal} is a conservative bound. The aggregate remains the
...
Eq.~\eqref{eq:aggsignal} (dotted: closed form) --- exact in the high-entropy
...
approximation, and Eq.~\eqref{eq:aggsignal} becomes a conservative bound
