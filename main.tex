...
perplexity under the generating model. Notes: (i) the union detector's
Bonferroni correction is conservative --- its realized FPR is $0.039/0.008$ at
nominal $0.05/0.01$ --- so at fixed \emph{nominal} thresholds the subkey arm's
TPR is slightly below the softened baseline despite a higher median $z$; at
matched \emph{realized} FPR the comparison tilts further toward the subkey arm.
