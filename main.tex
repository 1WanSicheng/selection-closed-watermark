...
Throughout, selection operators observe the candidates and auxiliary
randomness independent of the watermark key; base samplers draw all their
randomness from the keyed noise stream; the verifier knows $N$ or an upper
bound.
...
(ii) for \emph{every} (possibly randomized) selection operator $S$ as above,
the law of the selected output $Y_S$ equals that of $S$ applied to
unwatermarked i.i.d.\ candidates.
