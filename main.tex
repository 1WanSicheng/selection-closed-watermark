...
\begin{enumerate}
  ...
  \item \emph{Detection after candidate separation.} The base detector lifts
        ...
        detection --- plus $N$ parallel base-detector evaluations
        (\S\ref{sec:detection}).
...
shared-key workaround of \citet{verma2025watermarking}. We report reward of the selected
...
unchanged; union detection costs $\approx0.3$ z. The softened workaround
trades away the exact marginal certification and retains less post-selection
signal.}
\label{tab:main}
\begin{center}
\begin{tabular}{llccc}
